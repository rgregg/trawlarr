...
| `@trawlarr/plugins-core` | First-party flow nodes: Start, Check Video Codec, Check Audio Stream, Check Condition, Begin Command, Set Video Encoder, Audio Tracks, Subtitle Tracks, Set Container, Execute, Verify Output, Replace Original File, Write to Log, Fail File, On Error, and Hold for Review.                                                                                                                  |
